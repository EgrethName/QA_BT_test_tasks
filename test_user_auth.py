...
class TestCaseUserRegistration:
    ...
    test_cases = [
        ...
        pytest.param(POST, RegistrationData.REGISTRATION_PASSWORD1_IS_PASSWORDS2_SUBSET, 400, id="test_failed_registration_password1_is_passwords2_subset"),
        pytest.param(POST, RegistrationData.REGISTRATION_PASSWORD2_IS_PASSWORDS1_SUBSET, 400, id="test_failed_registration_password2_is_passwords1_subset"),
...
class TestCaseUserPasswordReplace:
    ...
    test_cases = [
        ...
        pytest.param(PUT, PasswordReplaceData.REPLACE_PASSWORD1_IS_PASSWORDS2_SUBSET, 400, id="test_failed_replace_password1_is_passwords2_subset"),
        pytest.param(PUT, PasswordReplaceData.REPLACE_PASSWORD2_IS_PASSWORDS1_SUBSET, 400, id="test_failed_replace_password2_is_passwords1_subset"),
